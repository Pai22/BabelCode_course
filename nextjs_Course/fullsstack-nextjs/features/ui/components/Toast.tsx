...
const Toast = () => {
  ...
  // ใช้ useShallow เพราะคืนค่าออกมาหลายตัว
  ...
  return (
    <div className="absolute right-5 bottom-5 flex w-full max-w-xs items-center rounded-lg bg-white p-4 text-gray-500 shadow dark:bg-gray-800 dark:text-gray-400">
      {Icon}
